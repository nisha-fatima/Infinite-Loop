...
import { getMetaMask } from "../../Pages/Home/Hero/Hero";
import "./Nav.css";
      ...
      >
        <div className="my-container flex flex-wrap justify-between items-center">
          ...
          >
            <img
              className="logo"
              src={require("../../assets/iloop-logo1.png")}
              alt="ILS"
            />
          </button>
          <div className="flex sm:order-last items-center">
            ...
            >
              {!!accountAddress ? accountDottedAddress : "Connect Wallet"}
            </button>
            <a
              target="_blank"
            ...
            >
              <img src={navicon} alt="" style={{ width: "66%" }} />
            </a>
          </div>
          <div className="hidden w-full lg:block md:w-auto" id="NavBarId">
            <ul className="flex flex-col mt-4 lg:flex-row lg:space-x-4 md:mt-0 text-base md:text-xl  md:font-medium text-main-white">
              <li
              ...
              <li
                onClick={() => scrollTo("#airdop")}
                className="text-white hover:text-orange-600"
              >
                <a href="#airdop" className="block py-2 pl-3 ">
                  Airdop
                </a>
              </li>
              ...
              <li
                ...
                className="text-white hover:text-orange-600"
              >
                <a href="#referrals" className="block py-2 pl-3 ">
                  Referrals
                </a>
              </li>
            </ul>
